...
/*
ALTER TABLE qui5aafu163l1ogs.vehicule DISCARD TABLESPACE;
DROP TABLE qui5aafu163l1ogs.vehicule;

ALTER TABLE qui5aafu163l1ogs.avis DISCARD TABLESPACE;
DROP TABLE qui5aafu163l1ogs.avis;

ALTER TABLE qui5aafu163l1ogs.horaires DISCARD TABLESPACE;
DROP TABLE qui5aafu163l1ogs.horaires;

ALTER TABLE qui5aafu163l1ogs.services DISCARD TABLESPACE;
DROP TABLE qui5aafu163l1ogs.services;

ALTER TABLE qui5aafu163l1ogs.utilisateurs DISCARD TABLESPACE;
DROP TABLE qui5aafu163l1ogs.utilisateurs;
*/

-- UTILISATEURS --------------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS qui5aafu163l1ogs.utilisateurs (
...
INSERT INTO qui5aafu163l1ogs.utilisateurs (id, nom, prenom, email, mdp) 
...
CREATE TABLE IF NOT EXISTS qui5aafu163l1ogs.vehicule (
...
INSERT IGNORE INTO qui5aafu163l1ogs.vehicule (nom, image, prix, annee, kilometrage, carburant)
...
CREATE TABLE IF NOT EXISTS qui5aafu163l1ogs.avis (
    nom VARCHAR(30),
    note TINYINT,
    message TEXT,
    estValide BOOLEAN
...
INSERT IGNORE INTO qui5aafu163l1ogs.avis (nom, note, message, estValide)
...
CREATE TABLE IF NOT EXISTS qui5aafu163l1ogs.horaires (
    jour VARCHAR(10) PRIMARY KEY,
    horaire VARCHAR(30)
);

INSERT IGNORE INTO qui5aafu163l1ogs.horaires (jour, horaire)
...
CREATE TABLE IF NOT EXISTS qui5aafu163l1ogs.services (
    id DECIMAL(1,0) PRIMARY KEY,
    contenu TEXT
);

INSERT INTO qui5aafu163l1ogs.services (id, contenu) 
...
SELECT * FROM qui5aafu163l1ogs.horaires;